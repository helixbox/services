        ...
        impl alloy_sol_types::SolConstructor for constructorCall {
            ...
            fn tokenize(&self) -> Self::Token<'_> {
                (
                    ...
                    <::alloy_sol_types::sol_data::Uint<
                        256,
                    > as alloy_sol_types::SolType>::tokenize(&self._rateNumerator),
                    <::alloy_sol_types::sol_data::Uint<
                        256,
                    > as alloy_sol_types::SolType>::tokenize(&self._rateDenominator),
                )
            }
        }
    };
...
```*/
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<rateDenominatorReturn>
            for UnderlyingRustTuple<'_> {
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`rateNumerator()`](rateNumeratorCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    impl alloy_sol_types::SolInterface for MockERC4626WrapperCalls {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                ...
                Self::rateNumerator(_) => {
                    <rateNumeratorCall as alloy_sol_types::SolCall>::SELECTOR
                }
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn rateNumerator(
                        ...
                        <rateNumeratorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                ...
                },
                {
                    fn rateDenominator(
                        ...
                        <rateDenominatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::rateDenominator(inner) => {
                    <rateDenominatorCall as alloy_sol_types::SolCall>::abi_encoded_size(
                        inner,
                    )
                }
                Self::rateNumerator(inner) => {
                    <rateNumeratorCall as alloy_sol_types::SolCall>::abi_encoded_size(
                        inner,
                    )
                }
                Self::transfer(inner) => {
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::rateDenominator(inner) => {
                    <rateDenominatorCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
                Self::rateNumerator(inner) => {
                    <rateNumeratorCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<MockERC4626WrapperInstance<P, N>>,
    > {
        MockERC4626WrapperInstance::<
            P,
            N,
        >::deploy(__provider, _asset, _decimals, _rateNumerator, _rateDenominator)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    impl<P, N> ::core::fmt::Debug for MockERC4626WrapperInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("MockERC4626WrapperInstance").field(&self.address).finish()
        }
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > MockERC4626WrapperInstance<P, N> {
        ...
        pub fn rateNumerator(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, rateNumeratorCall, N> {
...
pub type Instance = MockERC4626Wrapper::MockERC4626WrapperInstance<
