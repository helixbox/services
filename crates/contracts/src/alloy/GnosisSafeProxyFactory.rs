...
```*/
    ...
    pub struct calculateCreateProxyWithNonceAddressCall {
        ...
        #[allow(missing_docs)]
        pub initializer: ::alloy_sol_types::private::Bytes,
        #[allow(missing_docs)]
        pub saltNonce: ::alloy_sol_types::private::primitives::aliases::U256,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`calculateCreateProxyWithNonceAddress(address,bytes,uint256)`](calculateCreateProxyWithNonceAddressCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    const _: () = {
        ...
        #[automatically_derived]
        impl alloy_sol_types::SolCall for calculateCreateProxyWithNonceAddressCall {
            type Parameters<'a> = (
                ::alloy_sol_types::sol_data::Address,
                ::alloy_sol_types::sol_data::Bytes,
                ::alloy_sol_types::sol_data::Uint<256>,
...
```*/
    ...
    pub struct createProxyWithCallbackCall {
        ...
        pub saltNonce: ::alloy_sol_types::private::primitives::aliases::U256,
        #[allow(missing_docs)]
        pub callback: ::alloy_sol_types::private::Address,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`proxyRuntimeCode()`](proxyRuntimeCodeCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct proxyRuntimeCodeReturn {
        #[allow(missing_docs)]
        pub _0: ::alloy_sol_types::private::Bytes,
    }
    #[allow(
    ...
    impl GnosisSafeProxyFactoryCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[
            ...
            [97u8, 182u8, 154u8, 189u8],
            [173u8, 218u8, 204u8, 15u8],
            [209u8, 138u8, 245u8, 77u8],
        ];
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(createProxyWithNonce),
            ::core::stringify!(calculateCreateProxyWithNonceAddress),
            ::core::stringify!(proxyCreationCode),
            ::core::stringify!(createProxy),
            ::core::stringify!(proxyRuntimeCode),
            ::core::stringify!(createProxyWithCallback),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <createProxyWithNonceCall as alloy_sol_types::SolCall>::SIGNATURE,
            <calculateCreateProxyWithNonceAddressCall as alloy_sol_types::SolCall>::SIGNATURE,
            <proxyCreationCodeCall as alloy_sol_types::SolCall>::SIGNATURE,
            <createProxyCall as alloy_sol_types::SolCall>::SIGNATURE,
            <proxyRuntimeCodeCall as alloy_sol_types::SolCall>::SIGNATURE,
            <createProxyWithCallbackCall as alloy_sol_types::SolCall>::SIGNATURE,
        ];
    ...
    impl alloy_sol_types::SolInterface for GnosisSafeProxyFactoryCalls {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                ...
                Self::proxyRuntimeCode(_) => {
                    <proxyRuntimeCodeCall as alloy_sol_types::SolCall>::SELECTOR
                }
            }
        }
        #[inline]
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                {
                    fn calculateCreateProxyWithNonceAddress(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<GnosisSafeProxyFactoryCalls> {
                        <calculateCreateProxyWithNonceAddressCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
                            .map(
                                GnosisSafeProxyFactoryCalls::calculateCreateProxyWithNonceAddress,
                            )
                    }
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<GnosisSafeProxyFactoryCalls>] = &[
                {
                    fn createProxyWithNonce(
                        ...
                        <createProxyWithNonceCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(GnosisSafeProxyFactoryCalls::createProxyWithNonce)
                    }
                ...
                },
                {
                    fn calculateCreateProxyWithNonceAddress(
                        ...
                        <calculateCreateProxyWithNonceAddressCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(
                                GnosisSafeProxyFactoryCalls::calculateCreateProxyWithNonceAddress,
                ...
                },
                {
                    fn proxyCreationCode(
                        ...
                        <proxyCreationCodeCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(GnosisSafeProxyFactoryCalls::proxyCreationCode)
                    }
                ...
                },
                {
                    fn createProxyWithCallback(
                        ...
                        <createProxyWithCallbackCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(GnosisSafeProxyFactoryCalls::createProxyWithCallback)
                    }
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                Self::calculateCreateProxyWithNonceAddress(inner) => {
                    <calculateCreateProxyWithNonceAddressCall as alloy_sol_types::SolCall>::abi_encoded_size(
                        inner,
                    )
                }
                ...
                Self::proxyRuntimeCode(inner) => {
                    <proxyRuntimeCodeCall as alloy_sol_types::SolCall>::abi_encoded_size(
                        inner,
                    )
                }
            }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                Self::calculateCreateProxyWithNonceAddress(inner) => {
                    <calculateCreateProxyWithNonceAddressCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
                ...
                Self::proxyRuntimeCode(inner) => {
                    <proxyRuntimeCodeCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > GnosisSafeProxyFactoryInstance<P, N> {
        ...
        ///Creates a new call builder for the [`calculateCreateProxyWithNonceAddress`] function.
        pub fn calculateCreateProxyWithNonceAddress(
            &self,
        ...
        pub fn proxyCreationCode(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, proxyCreationCodeCall, N> {
            self.call_builder(&proxyCreationCodeCall)
        }
        ///Creates a new call builder for the [`proxyRuntimeCode`] function.
        pub fn proxyRuntimeCode(
            &self,
        ) -> alloy_contract::SolCallBuilder<&P, proxyRuntimeCodeCall, N> {
            self.call_builder(&proxyRuntimeCodeCall)
        }
    }
    /// Event filters.
    impl<
