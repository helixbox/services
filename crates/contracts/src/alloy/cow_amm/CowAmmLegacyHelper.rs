...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`getSnapshot(address)`](getSnapshotCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`isLegacy(address)`](isLegacyCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`isLegacyEnabled(address)`](isLegacyEnabledCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<isLegacyEnabledReturn>
...
```*/
    ...
    pub struct tokensReturn {
        #[allow(missing_docs)]
        pub _tokens: ::alloy_sol_types::private::Vec<
            ::alloy_sol_types::private::Address,
        >,
    }
    #[allow(
    ...
    impl alloy_sol_types::SolInterface for CowAmmLegacyHelperCalls {
            ...
            static DECODE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<CowAmmLegacyHelperCalls>] = &[
                {
                    fn isLegacyEnabled(
                        ...
                        <isLegacyEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                                data,
                            )
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                },
                {
                    fn isLegacy(
                        ...
                        <isLegacyCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(CowAmmLegacyHelperCalls::isLegacy)
                    }
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::isLegacyEnabled(inner) => {
                    <isLegacyEnabledCall as alloy_sol_types::SolCall>::abi_encoded_size(
                        inner,
                    )
                }
                Self::order(inner) => {
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::isLegacy(inner) => {
                    <isLegacyCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
                Self::isLegacyEnabled(inner) => {
                    <isLegacyEnabledCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
...
pub const fn deployment_info(chain_id: u64) -> Option<(Address, Option<u64>)> {
    match chain_id {
        1u64 => {
            Some((
                alloy_primitives::address!("0x3705ceee5eaa561e3157cf92641ce28c45a3999c"),
                Some(20332745u64),
            ))
        }
        100u64 => {
            Some((
                alloy_primitives::address!("0xd9ec06b001957498ab1bc716145515d1d0e30ffb"),
                Some(35026999u64),
            ))
        }
        _ => None,
