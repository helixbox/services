...
See the [wrapper's documentation](`UniswapV2Router02Instance`) for more details.*/
    ...
    >(
        ...
        UniswapV2Router02Instance::<P, N>::new(address, __provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(
        ...
        UniswapV2Router02Instance::<P, N>::deploy_builder(__provider, _factory, _WETH)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            ...
            _factory: ::alloy_sol_types::private::Address,
            _WETH: ::alloy_sol_types::private::Address,
        ) -> alloy_contract::Result<UniswapV2Router02Instance<P, N>> {
            let call_builder = Self::deploy_builder(__provider, _factory, _WETH);
